...
os.makedirs('/home/isocyanate/Downloads/link_verify',exist_ok=True)
...
for j in hrefs:
    try:
        ...
        if res.status_code != requests.codes.ok:
            ...
            savinglink = open(os.path.join('/home/isocyanate/Downloads/link_verify', os.path.basename(j+'.html')),'wb')
